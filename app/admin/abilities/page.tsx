...
export default function AbilitiesAdminPage() {
    ...
    <main className="flex-1 overflow-x-auto">
      <div className="max-w-[1180px] min-w-[900px] mx-auto px-6 py-10">
        <div className="flex items-center gap-2 text-sm text-zinc-500 dark:text-zinc-400 mb-4">
          ...
          <span>/</span>
          <span className="text-zinc-900 dark:text-zinc-100">Abilities</span>
        </div>

        <h1 className="text-2xl font-bold mb-1">Abilities</h1>
