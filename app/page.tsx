      ...
      >
        ...
        {url === "" && (
          <button
            ...
            className={`self-center inline-flex items-center gap-1 px-2 py-1 mr-2 rounded-md border font-mono text-[11px] font-medium transition-colors cursor-pointer ${
              pasteError
    ...
    >
      ...
      >
        ...
        <div className="absolute top-2.5 left-2.5 right-2.5 flex items-center gap-1.5">
          <span className="px-1.5 py-[3px] rounded bg-black/60 backdrop-blur-sm text-[10px] font-mono font-semibold text-slate-200">
            {shortCode(enc.name)}
          </span>
